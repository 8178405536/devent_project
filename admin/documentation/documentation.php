          ...
          <div class="col-md-3 col-xl-2 left-sidebar">
            <div class="logo-wrapper">
              <a href="../template/index.php">
                <img src="../template/assets/images/logo.svg" alt="logo" class="logo">
              </a>
            </div>
            ...
            <a class="d-block mt-4 text-muted" target="_blank" href="../template/index.php">Go to Home</a>
          </div>
                  ...
                  <div class="card-body py-0 px-0 px-sm-3">
                    <div class="row align-items-center">
                      ...
                      <div class="col-5 col-sm-7 col-xl-8 p-0">
                        ...
                        <p class="mb-0 font-weight-normal d-none d-sm-block">devent Admin template now with a new facelift for enhanced legibility and aesthetics!</p>
                      </div>
